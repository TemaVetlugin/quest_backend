...
class UpdateController extends Controller
{
    ...
    public function __invoke(Request $request, Quest $quest)
    {
        ...
        if($request->file('file_start')){
            ...
            if (isset($quest->file_start) && Storage::disk('public')->exists($quest->file_start)) {
                // Удаляем файл
        ...
        if($request->file('file_main')){
            ...
            if (isset($quest->file_main) && Storage::disk('public')->exists($quest->file_main)) {
                // Удаляем файл
        ...
        if($request->file('file_end')){
            ...
            if (isset($quest->file_end) && Storage::disk('public')->exists($quest->file_end)) {
                // Удаляем файл
